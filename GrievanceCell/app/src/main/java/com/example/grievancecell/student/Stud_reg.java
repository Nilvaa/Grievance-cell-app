...
public class Stud_reg extends AppCompatActivity {
    ...
    String cn,rno, dep, add, em, pa, ph, cou, gen;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(v -> {
            ...
            rno=roll_no.getText().toString();
            gen=gender.getSelectedItem().toString();
            if (cn.isEmpty()) {
                Snackbar.make(cnam, "Please Enter Name", Snackbar.LENGTH_LONG)
                ...
                Snackbar.make(roll_no, "Please Enter Roll Number", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                ...
                Snackbar.make(addres, "Please Enter Address", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                ...
                Snackbar.make(depart, "Please Enter Department", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
                ...
                Snackbar.make(course, "Please Enter Course", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    Toast.makeText(Stud_reg.this, "Sign Up successfully", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "StudentRegister");
                map.put("Rollno", rno);
                map.put("name", cn);
