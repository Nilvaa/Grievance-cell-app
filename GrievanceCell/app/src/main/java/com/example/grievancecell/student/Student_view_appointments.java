...
import com.example.grievancecell.adaptor.Student_appointment_adaptor;
...
public class Student_view_appointments extends AppCompatActivity {
    ListView list;
    List<SpeakNowModel> arraylist;
    public Student_appointment_adaptor adap;
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Student_appointment_adaptor(Student_view_appointments.this, arraylist);
                    list.setAdapter(adap);
                    registerForContextMenu(list);

                } else {
                    Toast.makeText(getApplicationContext(), "No appointments requested", Toast.LENGTH_LONG).show();
                }
            }
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "StudentViewAppointments");
                map.put("u_id", uid);
                return map;
            }
        };
