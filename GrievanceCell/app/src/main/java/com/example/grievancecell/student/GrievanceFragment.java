...
public class GrievanceFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root=  inflater.inflate(R.layout.fragment_grievance, container, false);
        date=root.findViewById(R.id.date);
        des=root.findViewById(R.id.des);
        type=root.findViewById(R.id.type);
        pro=root.findViewById(R.id.pro);
        sento=root.findViewById(R.id.sent);
        sent=root.findViewById(R.id.btnreg);
        ...
        ArrayAdapter arrayAdapter = new ArrayAdapter(getContext(), android.R.layout.simple_spinner_dropdown_item, gend) {
            @Override
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    Toast.makeText(requireActivity(), "Grievance Sent successfully", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "AddGrievance");
                map.put("u_id", uid);
                map.put("date", da);
                map.put("type", ty);
                map.put("proir", pr);
