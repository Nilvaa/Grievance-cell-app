...
import com.example.grievancecell.adaptor.Admin_view_reply_adaptor;
...
public class Admin_view_reply extends AppCompatActivity {
    ListView list;
    List<SpeakNowModel> arraylist;
    public Admin_view_reply_adaptor adap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_reply);
        list=findViewById(R.id.action);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Admin_view_reply_adaptor(Admin_view_reply.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "AdminViewActions");
                return map;
            }
        };
        queue.add(request);
