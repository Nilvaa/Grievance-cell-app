...
public class Admin_view_stud extends AppCompatActivity {
    ListView list;
    List<SpeakNowModel> arraylist;
    public Student_adaptor adap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_stud);
        list=findViewById(R.id.stud);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Student_adaptor(Admin_view_stud.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "ViewStudents");
                return map;
            }
        };
        queue.add(request);
