...
public class Faculty_view_grievance extends AppCompatActivity {
    ListView list;
    List<SpeakNowModel> arraylist;
    public Faculty_view_grie_adaptor adap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_view_grievance);
        list=findViewById(R.id.mygrie);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Faculty_view_grie_adaptor(Faculty_view_grievance.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "FacViewGrievances");
                map.put("u_id", uid);
                return map;
            }
        };
