...
public class Faculty_reg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(v -> {
            ...
            if (cn.isEmpty()) {
                ...
                Snackbar.make(desig, "Please Enter Designation", Snackbar.LENGTH_LONG)
                        .setAction("dismiss", new View.OnClickListener() {
                            @Override
                            public void onClick(View view) {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    Toast.makeText(Faculty_reg.this, "Sign Up successfully ", Toast.LENGTH_SHORT).show();
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "FacultyRegister");
                map.put("name", cn);
