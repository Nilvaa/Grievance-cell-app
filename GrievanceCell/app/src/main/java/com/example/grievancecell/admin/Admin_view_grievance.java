...
import com.example.grievancecell.adaptor.Admin_view_grievance_adaptor;
import com.example.grievancecell.adaptor.Facutly_adaptor;
import com.example.grievancecell.adaptor.Student_adaptor;
...
public class Admin_view_grievance extends AppCompatActivity {
    ListView list;
    List<SpeakNowModel> arraylist;
    public Admin_view_grievance_adaptor adap;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_view_grievance);
        list=findViewById(R.id.grie);
        ...
        StringRequest request = new StringRequest(Request.Method.POST, Utility.url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                if (!response.trim().equals("failed")) {
                    ...
                    adap = new Admin_view_grievance_adaptor(Admin_view_grievance.this, arraylist);
            ...
            protected Map<String, String> getParams() {
                ...
                map.put("requestType", "AdminVIewGrievance");
                return map;
            }
        };
        queue.add(request);
